const Steps = () => {
  return (
    <>
      <h1 className="text-left text-4xl md:text-5xl my-10 md:my-20 font-semibold">
        The Roadmap -&gt;
      </h1>
