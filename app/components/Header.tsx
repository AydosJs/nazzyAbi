    ...
    <header className="top-0 sticky p-4 px-6 sm:px-8 border-b bg-neutral-950 bg-opacity-60 backdrop-filter backdrop-blur-lg z-50 text-white border-neutral-800">
      <div className="container mx-auto flex flex-row flex-nowrap justify-between">
        ...
        <div className="sm:flex flex-row items-center space-x-2 hidden">
          <button className="p-2 px-3 cursor-pointer hover:bg-neutral-900 rounded-md flex flex-row items-center justify-center">
        ...
        {/* sidebar for mobile */}
        {isOpen && (
          <div className={`sm:hidden absolute p-0 mt-[72px] h-[calc(100vh-72px)] flex flex-col justify-between pb-0 top-0 right-0 z-40 overflow-auto border-l border-neutral-800 w-72 bg-neutral-950 bg-opacity-90 backdrop-filter backdrop-blur-3xl `}>
